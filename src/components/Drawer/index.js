...
function Drawer({ onClose, onRemove, items = [], opened }) {
    ...
    const onClickOrder = async () => {
        try {
            setIsLoading(true);
            const { data } = await axios.post('https://c11118ef405b6342.mokky.dev/orders', {
                items: cartItems,
            });
            setOrderId(data.id);
            ...
            for (let i = 0; i < cartItems.length; i++) {
                ...
                await axios.delete('https://c11118ef405b6342.mokky.dev/cart/' + item.id);
                await delay(1000);
            }
        } catch (error) {
        ...
        <div className={drawerStyles.drawer}>
            ...
            <div className='d-flex flex-column flex'>
                <div className={drawerStyles.items}>
                    {items.map((obj) => (
                        <div key={obj.id} className={drawerStyles.cartItem}>
                            <img className={drawerStyles.cartItemImg} src={obj.imageUrl} alt='Games' />
                ...
                <div className={drawerStyles.cartTotalBlock}>
                    ...
                    <button disabled={isLoading} onClick={onClickOrder} className={drawerStyles.lavenderButton}>
            ...
            <Info
               ...
               description={
                   isOrderComplete
                      ...
                      : "Добавьте хотя бы одну пару игр, чтобы сделать заказ."
                }
